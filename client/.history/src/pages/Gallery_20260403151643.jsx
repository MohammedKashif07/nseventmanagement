...
const Gallery = () => {
    ...
    // Filter logic now based on 'type' (image/video)
    ...
    return (
        <div className="bg-white min-h-screen font-sans selection:bg-blue-100 overflow-x-hidden">
                        ...
                        {filteredItems.map((item) => (
                            ...
                            >
                                ...
                                <div className="absolute top-6 left-6">
                                    <span className="px-4 py-1.5 bg-white/90 backdrop-blur shadow-sm text-[9px] font-black uppercase tracking-widest text-slate-900 rounded-full flex items-center gap-2">
            ...
            <section className="py-24 px-6">
                <div className="max-w-6xl mx-auto bg-slate-950 rounded-[3rem] p-8 md:p-16 text-white shadow-3xl relative overflow-hidden border border-white/5">
                    <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
                        <div className="text-center lg:text-left">
                            ...
                            <p className="text-blue-100/70 text-lg max-w-md leading-relaxed">
                                Love our media and service? Refer a partner. When they place their first order, you get ₹100 instantly.
                            </p>
                        </div>

                        <div className="bg-white/5 backdrop-blur-2xl p-10 rounded-[2.5rem] border border-white/10 text-center w-full max-w-sm">
                            <p className="text-blue-300 text-xs uppercase font-black tracking-[0.2em] mb-4 italic">Instant Payout</p>
