...
const Contact = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('https://dwknfrlbf0.execute-api.ap-south-1.amazonaws.com/default/api/contact', {
                method: 'POST',
                    ...
                    <div className="space-y-8 bg-white p-10 rounded-[3rem] shadow-xl border border-slate-100">
                        ...
                        <div className="flex items-start gap-6 group">
                            ...
                            <div>
                                ...
                                <p className="text-slate-900 text-lg font-bold wrap-break-word">nsservices.suppor@gmail.com</p>                            </div>
                        </div>
