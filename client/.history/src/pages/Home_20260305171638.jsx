...
const Home = () => {
    return (
        <div className="bg-white selection:bg-blue-100">
            ...
            <section id="home" className="relative h-[100vh] flex items-center justify-center overflow-hidden bg-slate-950">
                ...
                <div className="absolute inset-0 z-0">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-b from-blue-950/80 via-transparent to-slate-950"></div>
                </div>
