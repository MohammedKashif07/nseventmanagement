...
// --- COMPONENT IMPORT ---
// Ensure this path is correct. If it crashes, check ServiceCard.jsx
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {mainEvents.map((event, index) => (
                            <motion.div key={index} whileHover={{ y: -10 }}>
                                {/* Fallback if ServiceCard fails to load */}
                                {ServiceCard ? (
                                    <ServiceCard {...event} />
                                ) : (
                ...
                <div className="max-w-6xl mx-auto px-4">
                    <div className="bg-[#06065a] rounded-3xl p-10 grid grid-cols-2 md:grid-cols-4 text-center gap-10">
                        ...
                        <div>
                            ...
                            <h5 className="text-4xl text-white font-bold tracking-tighter md:text-4xl">On Time</h5>
