                ...
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
                        {products.map((item, idx) => (
                            ...
                            >
                                {/* Adjusted Image Container for Centering */}
                                <div className="aspect-4/3 overflow-hidden relative bg-slate-50 p-6 flex items-center justify-center">
                                    <img
                                        src={item.img}
                                        alt={item.title}
                                        /* FIXED: 'object-contain' ensures the whole bottle is visible.
                                           'mx-auto' and Flexbox on parent ensures it is centered.
                                        */
                                        className="max-w-full max-h-full object-contain group-hover:scale-110 transition-transform duration-700 mx-auto"
                                    />
