...
const Services = () => {
    ...
    // Simplified data structure - 'class' property removed as it's no longer needed
    const products = [
                ...
                <div className="max-w-7xl mx-auto px-4 relative z-10">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
                        {products.map((item, idx) => (
                            ...
                            >
                                {/* UNIFIED ALIGNMENT: 
                                   ALL items now use aspect-4/3 and object-cover for full consistency.
                                   Extra padding and Flex centering removed.
                                */}
                                <div className="aspect-4/3 overflow-hidden relative">
                                    <img
                                        src={item.img}
                                        alt={item.title}
                                        /* FIXED: All images now use 'h-full object-cover' */
            ...
            <section className="py-24 bg-white relative">
                <div className="max-w-7xl mx-auto px-4 relative z-10">
                    <div className="bg-slate-950 rounded-[3rem] md:rounded-[4rem] py-16 px-8 md:px-12 shadow-2xl relative overflow-hidden border border-slate-900">
                        ...
                        {/* Subtle Neon Glows inside the container */}
