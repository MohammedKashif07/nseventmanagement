...
// Added Sparkles, ShieldCheck, and Zap to the imports
import {
        ...
        <div className="bg-slate-50 min-h-screen font-sans selection:bg-blue-100">
            ...
            <section className="relative py-24 overflow-hidden bg-slate-900">
                ...
                <div className="relative max-w-6xl mx-auto px-4 text-center">
                    ...
                    >
                        Elevate Every <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-400">Occasion</span>
                    </motion.h1>
                    <motion.p
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
            ...
            <section className="py-24 bg-slate-900 relative overflow-hidden rounded-[3rem] mx-4">
            ...
            {/* Stats Section - Replaced "NS Experience" with this */}
