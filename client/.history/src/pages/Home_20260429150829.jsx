...
const Home = () => {
    return (
        <div className="bg-white selection:bg-blue-100 scroll-smooth">
            <Navbar />
                ...
                <div className="relative z-10 text-center px-6 max-w-5xl">
                    ...
                    >
                        ...
                        <p className="text-lg md:text-2xl text-blue-100/80 max-w-2xl mx-auto mb-10 font-medium leading-relaxed">
                            Transforming your vision into <span className="text-white border-b border-blue-400">extraordinary realities</span>.<br>From concept to execution, we manage it all.</br>
                        </p>
            ...
            {/* --- MAIN CONTENT: REMOVED GAPS --- */}
            <main className="relative flex flex-col">
                {/* Services Section */}
                {/* Services Section */}
                <section id="services" className="relative w-full m-0 p-0 block bg-white overflow-hidden">
                    <Services />
                </section>
                ...
                {/* Contact Section */}
                <section id="contact" className="relative w-full m-0 p-0 block bg-slate-50 overflow-hidden -mt-1">
                    <Contact />
                </section>
            </main>
            ...
            >
                <a href="https://wa.me/918667281229" target="_blank" rel="noopener noreferrer" className="flex items-center">
                    ...
                    <div className="relative">
                        ...
                        <div className="relative h-16 w-16 bg-linear-to-br from-green-400 to-green-600 rounded-2xl shadow-xl flex items-center justify-center border border-white/20 transition-all duration-300 group-hover:rotate-12 group-hover:scale-110">
            ...
            {/* --- FOOTER --- */}
            <footer className="bg-slate-950 text-white pt-20 pb-10 m-0">
                <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-12 border-b border-white/5 pb-16 text-center md:text-left">
                    <div className="col-span-1 md:col-span-2">
                        <h3 className="text-3xl font-black mb-6 tracking-tighter italic">NS EVENTS MANAGEMENT<span className="text-blue-500 not-italic">.</span></h3>
                        <p className="text-gray-400 max-w-sm leading-relaxed mx-auto md:mx-0 font-medium">
                            Providing premium supply and event management services across Tamil Nadu.
                        </p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 text-sm mb-2">nsservices.suppor@gmail.com</p>
                ...
                <div className="pt-8 text-center text-gray-500 text-[10px] uppercase tracking-[0.3em] font-bold">
                    © 2018 NS Event Management — Built for Excellence
                </div>
            </footer>
        </div>
    );
