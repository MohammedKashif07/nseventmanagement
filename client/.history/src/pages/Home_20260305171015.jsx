...
const Home = () => {
    return (
        <div className="bg-white">
            ...
            {/* --- HERO SECTION --- */}
            <section id="home" className="relative h-screen flex items-center justify-center bg-blue-900 text-blue overflow-hidden">
                ...
                <div className="relative z-10 text-center px-4">
                    <h1 className="text-5xl md:text-6xl font-black mb-5 tracking-light">
                        NS Event Management
                    </h1>
                    <p className="text-xl md:text-3xl italic font-light mb-10 text-blue-100">
