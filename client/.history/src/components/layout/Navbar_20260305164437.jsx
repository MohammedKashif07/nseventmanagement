        ...
        <div className="fixed top-0 w-full flex justify-center z-50 pt-6 px-4">
            ...
            >
                ...
                <div className="flex items-center gap-4">
                    <a
                        href="#contact"
                        className="hidden sm:block px-6 py-2.5 bg-blue-950 text-white text-xs font-bold uppercase tracking-tighter rounded-xl hover:bg-blue-600 transition-all hover:-translate-y-1 active:scale-95"
                    >
                        Start Planning
                    </a>
